function TOSN_create_dirs_script(numEnvs, rnd)
arff_folderlist=Generate_Env_Combinations(numEnvs, rnd);
...
jobObject=batch(intelCluster,'ToSN_Directory_Structure_2016',0,{arff_folderlist,rnd},'Pool',1,'CurrentFolder', '/nfs/16/osu8577/MATLABdir');
