function [crossval_InfoGainMAD] = RunTrainingScript_InfoGainMAD(arff_folder, alpha, round, top_k, heldout_or_single)
...
% Generate models for top_k InfoGainMAD features
fprintf('Generating models for InfoGainMAD alpha = %f ranked features\n',alpha);
fprintf('--------------------------------------------\n');
crossval_InfoGainMAD = GenerateModels_IoTDI(g_str_pathbase_model, path_to_InfoGainMAD_arffs);
fprintf('--------------------------------------------\n\n');