function [crossval_all,crossenv_all]=RunResultsScript_BigEnvs_SenSys(round, arff_folder, top_k)
...
%% Run mRMR_D algorithms -- delegated to function Results_Sensys_mRMRV_D_BigEnvs_norm
[crossval_mRMRV_D_norm_25, crossenvironment_mRMRV_D_norm_25] = Results_Sensys_mRMRV_D_BigEnvs_norm(arff_folder, 0.25, round, top_k, 's');
[crossval_mRMRV_D_norm_50, crossenvironment_mRMRV_D_norm_50] = Results_Sensys_mRMRV_D_BigEnvs_norm(arff_folder, 0.5, round, top_k, 's');
[crossval_mRMRV_D_norm_75, crossenvironment_mRMRV_D_norm_75] = Results_Sensys_mRMRV_D_BigEnvs_norm(arff_folder, 0.75, round, top_k, 's');
[crossval_mRMRV_D_norm_full, crossenvironment_mRMRV_D_norm_full] = Results_Sensys_mRMRV_D_BigEnvs_norm(arff_folder, 1.0, round, top_k, 's');
[crossval_mRMRV_D_norm_10x, crossenvironment_mRMRV_D_norm_10x] = Results_Sensys_mRMRV_D_BigEnvs_norm(arff_folder, 10.0, round, top_k, 's');
[crossval_mRMRV_D_norm_50x, crossenvironment_mRMRV_D_norm_50x] = Results_Sensys_mRMRV_D_BigEnvs_norm(arff_folder, 50.0, round, top_k, 's');

alpha = {'25', '50', '75', 'full', '10x', '50x'};
for a=1:length(alpha)
    save(strcat(path_to_out_mats,'/crossval_mRMRV_D_norm_alpha_',alpha{a},'_',num2str(top_k),'.mat'),strcat('crossval_mRMRV_D_norm_',alpha{a}));
    save(strcat(path_to_out_mats,'/crossenvironment_mRMRV_D_norm_alpha_',alpha{a},'_',num2str(top_k),'.mat'),strcat('crossenvironment_mRMRV_D_norm_',alpha{a}));
end

%% Compute crossval matrix
crossval_all = [[ crossval_InfoGain{:,4} ]' [ crossval_mRMR_D{:,4} ]' [ crossval_mRMR_D_minEnvs{:,4} ]' [ crossval_mRMRV_D_norm_25{:,4} ]' [ crossval_mRMRV_D_norm_50{:,4} ]' [ crossval_mRMRV_D_norm_75{:,4} ]' [ crossval_mRMRV_D_norm_full{:,4} ]' [ crossval_mRMRV_D_norm_10x{:,4} ]' [ crossval_mRMRV_D_norm_50x{:,4} ]'];
crossenv_all = [[ crossenvironment_InfoGain{:,3} ]' [ crossenvironment_mRMR_D{:,3} ]' [ crossenvironment_mRMR_D_minEnvs{:,3} ]' [ crossenvironment_mRMRV_D_norm_25{:,3} ]' [ crossenvironment_mRMRV_D_norm_50{:,3} ]' [ crossenvironment_mRMRV_D_norm_75{:,3} ]' [ crossenvironment_mRMRV_D_norm_full{:,3} ]' [ crossenvironment_mRMRV_D_norm_10x{:,3} ]' [ crossenvironment_mRMRV_D_norm_50x{:,3} ]'];