function MASS_create_dirs_script(numEnvs, rnd)
...
jobObject=batch(intelCluster,'MASS_Directory_Structure_2017',0,{arff_folderlist,rnd},'Pool',1,'CurrentFolder', '~/MATLABdir');
