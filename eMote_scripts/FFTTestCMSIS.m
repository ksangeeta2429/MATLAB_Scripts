...
NumN = 25;
Nrep = 2;
MaxBufferSize = 128; %Maximum buffer size to use on device before splitting. Supported FFT Lengths are 16, 64, 256, 1024. 
...
SizeofFFT = 64; %Supported FFT Lengths are 16, 64, 256, 1024. 
%% Initialization
...
for Nindex = 1:numel(Narray)
    ...
    for repindex = 1 : Nrep
        ...
        for chunkindex = 1:numel(BegofDataChunksIndexes)
            ...
            data_chunk = data(firstindexinchunk:lastindexinchunk);
