...
% 
% Index = [2,6,7,8,9,10,11]; %205 246
% data_human = {'\IPSNdata\prb_2\Human','\IPSNdata\9603_6','\IPSNdata\Glacier_Ridge_7','IPSNdata\Ballantrae_8','\IPSNdata\Coffman_9','\IPSNdata\ceiling_238_10\Human','NIL'};
% data_dog = {'\IPSNdata\prb_2\Dog','NIL','NIL','NIL','NIL','\IPSNdata\ceiling_238_10\Dog','\IPSNdata\dog_cut_11'};
% featureClass = 0;

Index = [10]; %205 246
data_human = {'\IPSNdata\ceiling_238_10\Human'};
data_dog = {'\IPSNdata\ceiling_238_10\Dog'};
featureClass = 0;
