...
% Index = [3,4,5]; %205 246
% data_human = {'\IPSNdata\kh_3\Human','\IPSNdata\bv_4\Human','\IPSNdata\combined_5\Human'};
% data_dog = {'\IPSNdata\kh_3\Dog','\IPSNdata\bv_4\Dog','IPSNdata\combined_5\Dog'};

Index = [5]; %205 246
data_human = {'\IPSNdata\combined_5\Human'};
data_dog = {'\IPSNdata\combined_5\Dog'};
