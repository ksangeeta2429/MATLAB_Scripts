...
arff_folderlist={'1_2_4_5_9'};
rnd=999;

%path_to_all_arffs =
%strcat(g_str_pathbase_radar,'/IIITDemo/Arff/Datasets_ToSN'); % TODO: Uncomment this
path_to_all_arffs = strcat(g_str_pathbase_radar,'/IIITDemo/Arff/Data_IPSN2017_manyEnvs'); % TODO: Comment this
...
for fld=1:length(arff_folderlist)
    ...
    %for cur_rnd={'15'}
        ...
        evalstr=strcat('[crossval_',fldr,'_r1_top',char(cur_rnd),',','crossenv_',fldr,'_r1_top',char(cur_rnd),']=RunResultsScript_BigEnvs_MADOnly_ToSN(rnd,fldr,str2num(char(cur_rnd)));');
        eval([evalstr]);
    end
end
