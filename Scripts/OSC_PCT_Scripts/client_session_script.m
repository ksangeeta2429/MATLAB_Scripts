...
cd('C:\Users\royd\Documents\MATLAB\OSCMatlabPCT\Jobs');
...
% jobObject=batch(intelCluster,'eigtest','Pool',11,'CurrentFolder', '/nfs/16/osu8577/MATLABdir/');
% jobObject=batch(intelCluster,'TestJob','Pool',1,'CurrentFolder', '/nfs/16/osu8577/MATLABdir/');
%% jobObject=batch(intelCluster,'ToSN_parallel_2016',0,{arff_folderlist,rnd},'Pool',25,'CurrentFolder', '/nfs/16/osu8577/MATLABdir');
jobObject=batch(intelCluster,'GenerateModels_Parallel_IoTDI',1,{'/nfs/16/osu8577/MATLABdir/test','/nfs/16/osu8577/MATLABdir/test'},'Pool',25,'CurrentFolder', '/nfs/16/osu8577/MATLABdir');
...
%Note: Change the last variable. See details at line 28.
