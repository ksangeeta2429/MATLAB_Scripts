function [crossval_all, crossenv_all]=RunResultsScript_BigEnvs_MADOnly_ToSN(round, arff_folder, top_k)
...
crossval_all = [[ crossval_mRMRMAD_D_norm_25{:,4} ]' [ crossval_mRMRMAD_D_norm_50{:,4} ]' [ crossval_mRMRMAD_D_norm_75{:,4} ]' [ crossval_mRMRMAD_D_norm_full{:,4} ]' [ crossval_mRMRMAD_D_norm_10x{:,4} ]' [ crossval_mRMRMAD_D_norm_50x{:,4} ]'];
crossenv_all = [[ crossenvironment_mRMRMAD_D_norm_25{:,3} ]' [ crossenvironment_mRMRMAD_D_norm_50{:,3} ]' [ crossenvironment_mRMRMAD_D_norm_75{:,3} ]' [ crossenvironment_mRMRMAD_D_norm_full{:,3} ]' [ crossenvironment_mRMRMAD_D_norm_10x{:,3} ]' [ crossenvironment_mRMRMAD_D_norm_50x{:,3} ]'];
