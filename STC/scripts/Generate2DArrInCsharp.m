...
function Generate2DArrInCsharp(OutIndex,SV_matlab,param,sigma,omega,rho,feature_min,scalingFactors)  
fid = fopen(['C:\Users\he\Documents\Dropbox\MyMatlabWork\radar\STC\Models\ModelParameters\ModelParameters_Csharp',num2str(OutIndex),'.txt'],'w');

%% write rho and gamma
fprintf(fid, ['rho = ', num2str(rho), 'f;\n']);
fprintf(fid, ['sigma = ', num2str(sigma), 'f;\n']);
fprintf(fid, ['omega = ', num2str(omega), 'f;\n']);
