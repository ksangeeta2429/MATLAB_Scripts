...
for i=1:nInst
    ...
    if i>=3 && i<=nInst-2 && num_true(i-2)==num_true(i) && num_true(i-1)==num_true(i) && num_true(i+1)==num_true(i) && num_true(i+2)==num_true(i)
%         num_est(i)=mode(round(num_est(i-2:i+2)));
%         num_est(i)=mean(num_est(i-2:i+2));
%         num_est(i)=median(num_est(i-2:i+2));
    end
end
