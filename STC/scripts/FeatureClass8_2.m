...
function f=FeatureClass8_2(I, Q, thr)
...
for i=1:N
    ...
    if i==N && amp(i)>thr % 到尾巴了，但结束不了这次的counting
    ...
    if i==N && amp1(i)>thr % 到尾巴了，但结束不了这次的counting
    ...
    if i==N && amp2(i)>thr % 到尾巴了，但结束不了这次的counting
